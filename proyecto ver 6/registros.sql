-- SQLite
INSERT INTO Nacionalidades (IDNACIONALIDAD, NANOMBRE, NAPAIS) VALUES
(1, 'Británica', 'Reino Unido'),
(2, 'Colombiana', 'Colombia'),
(3, 'Japonesa', 'Japón'),
(4, 'Estadounidense', 'Estados Unidos'),
(5, 'Rusa', 'Rusia'),
(6, 'Canadiense', 'Canadá'),
(7, 'Mexicana', 'México'),
(8, 'Francesa', 'Francia'),
...
(14, 'Chilena', 'Chile'),
(15, 'Peruana', 'Perú'),
(16, 'Venezolana', 'Venezuela'),
(17, 'Ecuatoriana', 'Ecuador'),
(18, 'Uruguaya', 'Uruguay'),
(19, 'Paraguaya', 'Paraguay'),
(20, 'Boliviana', 'Bolivia'),
(21, 'Portuguesa', 'Portugal'),
(22, 'Holandesa', 'Países Bajos'),
(23, 'Belga', 'Bélgica'),
(24, 'Sueca', 'Suecia'),
(25, 'Noruega', 'Noruega'),
(26, 'Finlandesa', 'Finlandia'),
(27, 'Danés', 'Dinamarca'),
(28, 'Polaca', 'Polonia'),
(29, 'Húngara', 'Hungría'),
(30, 'Griega', 'Grecia'),
(31, 'Turca', 'Turquía'),
(32, 'Austríaca', 'Austria'),
(33, 'Suiza', 'Suiza'),
(34, 'Checa', 'República Checa'),
(35, 'Eslovaca', 'Eslovaquia'),
(36, 'Eslovena', 'Eslovenia'),
(37, 'Croata', 'Croacia'),
(38, 'Búlgara', 'Bulgaria'),
(39, 'Rumana', 'Rumanía'),
(40, 'Serbia', 'Serbia'),
(41, 'Bosnia y Herzegovina', 'Bosnia y Herzegovina'),
(42, 'Montenegrina', 'Montenegro'),
(43, 'Macedonia del Norte', 'Macedonia del Norte'),
(44, 'Albanesa', 'Albania'),
(45, 'Lituana', 'Lituania'),
(46, 'Letona', 'Letonia'),
(47, 'Estonia', 'Estonia'),
(48, 'Armenia', 'Armenia'),
(49, 'Georgiana', 'Georgia'),
(50, 'Azerí', 'Azerbaiyán'),
(51, 'Kazaja', 'Kazajistán'),
(52, 'Uzbeca', 'Uzbekistán'),
(53, 'Tayika', 'Tayikistán'),
(54, 'Kirguís', 'Kirguistán'),
(55, 'Turkmena', 'Turkmenistán'),
(56, 'Iraní', 'Irán'),
(57, 'Iraquí', 'Irak'),
(58, 'Afgana', 'Afganistán'),
(59, 'Saudí', 'Arabia Saudita'),
(60, 'Emiratí', 'Emiratos Árabes Unidos'),
(61, 'Qatarí', 'Qatar'),
(62, 'Bahrainí', 'Bahrein'),
(63, 'Omaní', 'Omán'),
(64, 'Kuwaití', 'Kuwait'),
...
(68, 'Jordana', 'Jordania'),
(69, 'Israelí', 'Israel'),
(70, 'Palestina', 'Palestina'),
(71, 'Egipcia', 'Egipto'),
(72, 'Libia', 'Libia'),
(73, 'Sudanesa', 'Sudán'),
(74, 'Argelina', 'Argelia'),
(75, 'Marroquí', 'Marruecos'),
(76, 'Tunecina', 'Túnez'),
(77, 'Saharaui', 'Sahara Occidental'),
(78, 'Mauritana', 'Mauritania'),
(79, 'Maliana', 'Mali'),
(80, 'Nigerina', 'Níger'),
(81, 'Chadiana', 'Chad'),
(82, 'Sudanesa del Sur', 'Sudán del Sur'),
(83, 'Eritrea', 'Eritrea'),
(84, 'Djiboutiana', 'Djibouti'),
(85, 'Somalí', 'Somalia'),
(86, 'Etíope', 'Etiopía'),
(87, 'Keniana', 'Kenia'),
(88, 'Ugandesa', 'Uganda'),
(89, 'Ruandesa', 'Ruanda'),
(90, 'Burundesa', 'Burundi'),
(91, 'Tanzana', 'Tanzania'),
(92, 'Mozambiqueña', 'Mozambique'),
(93, 'Malauí', 'Malaui'),
(94, 'Zambiana', 'Zambia'),
(95, 'Zimbabuense', 'Zimbabue'),
(96, 'Botswanesa', 'Botsuana'),
(97, 'Namibiana', 'Namibia'),
(98, 'Sudafricana', 'Sudáfrica'),
(99, 'Suazi', 'Esuatini'),
(100, 'Lesotense', 'Lesoto'),
(101, 'Comorana', 'Comoras'),
(102, 'Seychellense', 'Seychelles'),
(103, 'Mauriciana', 'Mauricio'),
(104, 'Maldiva', 'Maldivas'),
(105, 'Sri Lankan', 'Sri Lanka'),
(106, 'Bangladesí', 'Bangladés'),
(107, 'Bhutanesa', 'Bután'),
(108, 'Nepalí', 'Nepal'),
(109, 'Pakistaní', 'Pakistán'),
(110, 'India', 'India');
INSERT INTO Autores (IDAUTOR, AUNOMBRE, AUAPELLIDO, IDNACIONALIDAD, AUFECHANACIMIENTO) VALUES
(1, 'Joanne', 'Rowling', 1, '1965-07-31'),
(2, 'George', 'Orwell', 1, '1903-06-25'),
(3, 'Gabriel', 'García Márquez', 2, '1927-03-06'),
(4, 'Haruki', 'Murakami', 3, '1949-01-12'),
(5, 'Jane', 'Austen', 1, '1775-12-16'),
(6, 'Mark', 'Twain', 4, '1835-11-30'),
(7, 'Leo', 'Tolstoy', 5, '1828-09-09'),
(8, 'Virginia', 'Woolf', 1, '1882-01-25'),
(9, 'Fyodor', 'Dostoevsky', 5, '1821-11-11'),
(10, 'Charles', 'Dickens', 1, '1812-02-07'),
(11,'Pablo','Vierci',18,'1950-07-07');
...
(11,'ALREVES',123478596);
INSERT INTO Libros (IDLIBRO, IDEDITORIAL, IDCATEGORIA, LIBTITULO, LIBDESCRIPCION, LIBISBN, LIBANOPUBLICACION, LIBCANTIDAD) VALUES
(1, 1, 1, 'Harry Potter y la piedra filosofal', 'El primer libro de la serie Harry Potter, donde Harry descubre que es un mago.', '9788478884452', 1997, 50),
(2, 2, 2, '1984', 'Una distopía sobre una sociedad bajo vigilancia constante.', '9780451524935', 1949, 30),
(3, 3, 3, 'Cien años de soledad', 'La historia de la familia Buendía a lo largo de siete generaciones.', '9780307474728', 1967, 40),
(4, 4, 4, 'Kafka en la orilla', 'Una compleja novela que entrelaza diferentes historias.', '9781400079278', 2002, 25),
(5, 5, 5, 'Orgullo y prejuicio', 'Una de las primeras comedias románticas en la historia de la novela.', '9781503290563', 1813, 45),
(6, 6, 6, 'Las aventuras de Tom Sawyer', 'Las aventuras de un joven en el sur de Estados Unidos.', '9780486400778', 1876, 35),
(7, 7, 7, 'Guerra y paz', 'Una de las obras más importantes de la literatura rusa, sobre la invasión napoleónica.', '9780307389640', 1869, 20),
(8, 8, 8, 'Al faro', 'Una reflexión sobre la familia, la pérdida y los recuerdos.', '9780156030472', 1927, 15),
(9, 9, 9, 'Crimen y castigo', 'La historia de un joven estudiante que comete un asesinato.', '9780486415871', 1866, 50),
(10, 10, 10, 'Oliver Twist', 'La vida de un huérfano en Londres y su lucha por la supervivencia.', '9780486424538', 1838, 30),
(11, 11, 6, 'La sociedad de la nieve', 'Cincuenta años después de la tragedia de los Andes, los sobrevivientes narran cómo lograron superar lo insuperable. El 13 de octubre de 1972 un avión de la Fuerza Aérea Uruguaya se estrelló en la cordillera de los Andes. ', '9788418584732', 2008, 20);

INSERT INTO AutoresLibros (IDAUTOR, IDLIBRO) VALUES
(1, 1),  
(2, 2), 
(3, 3),  
(4, 4),  
