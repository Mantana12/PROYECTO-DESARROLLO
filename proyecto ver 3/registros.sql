...
(1, 1, 1, 1, 'Harry Potter y la piedra filosofal', 'El primer libro de la serie Harry Potter, donde Harry descubre que es un mago.', '978-8478884452', 1997, 50),
(2, 2, 2, 2, '1984', 'Una distopía sobre una sociedad bajo vigilancia constante.', '978-0451524935', 1949, 30),
(3, 3, 3, 3, 'Cien años de soledad', 'La historia de la familia Buendía a lo largo de siete generaciones.', '978-0307474728', 1967, 40),
(4, 4, 4, 4, 'Kafka en la orilla', 'Una compleja novela que entrelaza diferentes historias.', '978-1400079278', 2002, 25),
(5, 5, 5, 5, 'Orgullo y prejuicio', 'Una de las primeras comedias románticas en la historia de la novela.', '978-1503290563', 1813, 45),
(6, 6, 6, 6, 'Las aventuras de Tom Sawyer', 'Las aventuras de un joven en el sur de Estados Unidos.', '978-0486400778', 1876, 35),
(7, 7, 7, 7, 'Guerra y paz', 'Una de las obras más importantes de la literatura rusa, sobre la invasión napoleónica.', '978-0307389640', 1869, 20),
(8, 8, 8, 8, 'Al faro', 'Una reflexión sobre la familia, la pérdida y los recuerdos.', '978-0156030472', 1927, 15),
(9, 9, 9, 9, 'Crimen y castigo', 'La historia de un joven estudiante que comete un asesinato.', '978-0486415871', 1866, 50),
(10, 10, 10, 10, 'Oliver Twist', 'La vida de un huérfano en Londres y su lucha por la supervivencia.', '978-0486424538', 1838, 30);
